      ...
      <section className="overflow-hidden bg-black py-12 text-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-center justify-around gap-8 text-center">
            ...
            <div className="hidden h-12 w-px bg-slate-800 md:block" />
            <div>
              <div className="text-4xl font-black text-rose-600">{isSuspicious ? 'MIRROR' : 'LEGIT'}</div>
            ...
            <div>
              ...
              <p className="mb-10 text-lg leading-relaxed text-slate-600">
                {isSuspicious
                  ...
                  : 'Your identity is your most valuable asset. APEX Motors uses the Legit Pipeline to ensure that your sensitive documents never leave your device. We verify your credentials in a secure vault and only receive the green light for your purchase.'}
              </p>
            ...
            >
              ...
              <p className="mx-auto mb-12 max-w-2xl text-xl font-medium text-slate-400">
                {isSuspicious
                  ...
                  : 'Complete your high-value purchase verification with Legit and take the keys to your APEX supercar.'}
      ...
      <footer className="border-t border-slate-200 bg-slate-50 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-slate-400">
            {isSuspicious ? 'CLONED TRUST SURFACE FOR SHIELDNET DEMO' : '© 2026 APEX RACING DEPT x LEGIT PIPELINE'}
          </p>
        </div>
      </footer>
    </div>
